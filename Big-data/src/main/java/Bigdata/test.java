...
public class test {
    public static void main(String[] args) throws Exception{
        ...
        FileInputFormat.addInputPath(job, new Path("hdfs://localhost:9000//user//hiberstack//health_messages//"));
    ...
    public static class Reduce extends Reducer<Text, Text, Text, Text> {
        public void reduce(Text key, Iterable<Text> values, Context output) throws IOException, InterruptedException {
            ...
            sumRAM/=countMessage;
            String result="cpu: "+sumCpu+" "+"Disk: "+sumDisk+" "+"RAM: "+sumRAM+" "+"CPUT: "+maxCpuT+" "+"DiskT: "+maxDiskT+" "+"RAMT"+maxRAMT+" "+"count:"+countMessage;
